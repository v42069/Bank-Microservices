...
interface DeleteLoanFormProps {
  onSubmit: (mobileNumber: string) => Promise<void>
}

export function DeleteLoanForm({ onSubmit }: DeleteLoanFormProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Loan has been permanently deleted.",
      })
      setMobileNumber("")
    } catch (error) {
      toast({
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Permanently delete a loan by mobile number
        </CardDescription>
      </CardHeader>
      <CardContent>
